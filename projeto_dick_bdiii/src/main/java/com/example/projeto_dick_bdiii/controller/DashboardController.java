...
import com.example.projeto_dick_bdiii.domain.dto.dashboard.DashboardResponseDTO;
import com.example.projeto_dick_bdiii.domain.service.DashboardService;
...
public class DashboardController {
    ...
    public ResponseEntity<DashboardResponseDTO> obterFluxoDeCaixa(
        ...
        .obterFluxoDeCaixa(periodoInicial, periodoFinal));
    }
}
